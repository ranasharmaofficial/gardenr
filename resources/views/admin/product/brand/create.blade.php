            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body booking_card">
                        <form method="post" id="add-speciality-form" action="{{ route('admin.brand.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row formtype">
								...
								<div class="col-xxl-6 col-lg-4 col-sm-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter Brand Name" class="form-control" name="name">
                                    </div>
                                </div>
                                ...
                                <div class="col-xxl-6 col-lg-4 col-sm-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="file" placeholder="Enter " class="form-control" name="logo">
                                    </div>
                                </div>
