            ...
            <div class="col-md-12">
                <div class="card card-table">
					<div class="card-header d-flex align-items-center justify-content-between">
						...
						<a href="{{ url('admin/brand/create') }}" class="btn btn-primary ms-auto btn-sm">Add Brand</a>
					</div>
					...
					{{--<form method="GET" class="form">
                        ...
                        <div class="table-responsive mt-3">
                            <table id="basicExample" class="table truncate m-0 align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $value->name }}</td>
                                        <td>{{ $value->slug }}</td>
                                        <td><img style="max-width: 26px;width: 26px;" src="{{ static_asset($value->logo) }}"></td>
                                        <td>
                                        ...
                                        <td class="text-right">
                                            <a href="{{ route('admin.brand.edit',$value->id) }}" class="btn btn-icon btn-sm btn-danger-light rounded-pill" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit Brand"><i class="ri-edit-line"></i></a>
										</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            ...
                            <div class="pagination">
                                {{ $brand_list->appends(request()->input())->links() }}
                            </div>
