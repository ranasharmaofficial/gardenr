				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header d-flex align-items-center justify-content-between">
							...
							<a href="{{ url('admin/brand') }}" class="btn btn-primary ms-auto btn-sm">Brand List</a>
						</div>
						 
						<div class="card-body booking_card">
							<form method="post" id="update-speciality-form" action="{{ route('admin.brand.update',$data->id) }}" enctype="multipart/form-data">
								@csrf
								@method('put')
								<div class="row formtype">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $data->name }}" placeholder="Enter Brand Name" class="form-control" name="name">
                                    </div>
                                </div>
								...
								<div class="col-xxl-6 col-lg-4 col-sm-6 mb-3">
									...
									<div class="col-xxl-6 col-lg-4 col-sm-6 mb-3">
										<div class="form-group">
											...
											<input type="file" placeholder="Enter Icons" class="form-control" name="logo">
											<img style="margint-top:5px;max-width: 30px;width:30px;" src="{{ static_asset($data->logo) }}">
										</div>
									</div>
								...
								<div class="d-flex gap-2 justify-content-end mt-4">
								  <a href="{{ url('admin/brand') }}" class="btn btn-outline-secondary">
									Cancel
								  </a>
...
<script src="https://code.jquery.com/jquery-3.4.1.js"></script>
	...
	$(document).on('click', '.update-button', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.brand.update',$data->id) }}",
            data: formData,
            processData: false,
            contentType: false,
            dataType: "JSON",
