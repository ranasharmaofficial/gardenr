            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body booking_card">
                        <form method="post" id="add-speciality-form" action="{{ route('admin.colors.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row formtype">
								...
								<div class="col-xxl-6 col-lg-4 col-sm-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter Color Name" class="form-control" name="name">
                                    </div>
                                </div>
								...
								<div class="col-xxl-6 col-lg-4 col-sm-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="color" placeholder="Enter Color Code like #fffff" class="form-control" name="code">
                                    </div>
                                </div>
							</div>
                            <!-- Card acrions starts -->
