...
<!-- Page Header -->
            <div style="background:linear-gradient(45deg, #f33057, rgb( 56, 88, 249 ) );"  class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                <div>
                    <h4 class="fw-medium mb-2">Fund transfer to Employee</h4>
                            ...
                            <div class="card custom-card">
                                <div class="card-header  d-flex justify-content-between align-items-center">
                                    <div class="card-title">
										...
										<a href="{{ url('admin/fund-transferred-list') }}"
										   class="btn btn-danger btn-sm float-end">
										   Fund Transferred List
										</a>
                                </div>
								<form class="card-body" id="fund-transfer-to-employee-form" method="post" action="{{ route('admin.storeFund') }}" enctype="multipart/form-data">
									@csrf
									...
									<div class="row justify-content-center">
										<div class="col-sm-4">
											<div class="fund-card wallet-bg text-center">
												...
												<a href="javascript:void();" class="btn btn-danger btn-sm">Request for Fund</a>
											</div>
										</div>
									</div>
									...
									<div class="row formtype">
										...
										<div class="col-sm-6">
											<label class="col-form-label">Select User Type <star>*</star></label>
										...
										<div class="col-sm-6">
											<label class="col-form-label">Select Designation <star>*</star></label>
											<select class="form-control" id="user_designation" name="user_designation" required>
												<option value="">Select Designation</option>
											</select>
										</div>

										<div class="col-sm-6">
											<label class="col-form-label">Select Employee <star>*</star></label>
										...
										<div class="col-sm-6">
                                            <label for="course_id" class="col-form-label">Select Type<star>*</star></label>
									...
									<button type="submit" class="btn btn-primary mt-3 saveFund">Fund Transfer</button>
								</form>
                            </div>
                        </div>
    ...
    @if(loggedCompany()==1)
		$.ajax({
			type: "POST",
            url: "{{ route('admin.funds.admintransferFundtoEmployee') }}",
			data: formData,
			processData: false,
			contentType: false,
			dataType: "JSON",
