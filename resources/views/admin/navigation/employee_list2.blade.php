...
<div style="background:linear-gradient(45deg, #f33057, rgb( 56, 88, 249 ) );"  class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
    <div>
        <h4 class="fw-medium mb-2">Assign Shop to Employee</h4>
        <div class="ms-sm-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">{{ $page_title }}</a></li>
                    <li class="breadcrumb-item active fw-normal" aria-current="page">Assign Shop</li>
                </ol>
            </nav>
        </div>
    </div>
							...
							<div class="col-sm-12">
								<div class="card card-table">
									<div class="card-header d-flex align-items-center justify-content-between">
										<h5 class="card-title">Assign District</h5>
									...
									<div class="card-body booking_card">
										...
										<div class="table-responsive">
											<div id="user-table">
												@include('admin.navigation.partials.user_table_ajax2', ['users' => $users])
											</div>
...
<script>
    function fetchUsers(page = 1) {
        ...
        $.ajax({
            url: "{{ route('admin.staff.fetchEmployeeStaff2') }}?page=" + page,
            method: "GET",
            data: {
                user_type_id,
                user_designation_id,
