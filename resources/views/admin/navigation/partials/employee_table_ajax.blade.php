<table class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
				{{-- <a href="{{ route('admin.navigation.assignEmployeeDistrict', $user->id) }}" class="btn btn-danger btn-sm btn-danger-light">Assign</a> --}}
				<a href="{{ route('admin.navigation.assignEmployeeShop', $user->id) }}" class="btn btn-danger btn-sm btn-danger-light">Assign</a>
			</td>
