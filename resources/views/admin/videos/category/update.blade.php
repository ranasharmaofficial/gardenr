...
@section('title', 'Training Video Category')
@section('content')
				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header d-flex align-items-center justify-content-between">
							<h5 class="card-title">Training Video Category</h5>
							<a href="{{ url('admin/training_video_category_list') }}" class="btn btn-primary ms-auto">Training Video Category List</a>
						</div>
						<div class="card-body booking_card">
							<form method="post" id="update-speciality-form" action="{{ route('admin.training_video_category_list.update',$data->id) }}" enctype="multipart/form-data">
								@csrf
								@method('put')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select placeholder="Enter Category Name" class="form-control" name="parent_id" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
											...
											@foreach ($categories as $category)
												@include('admin.videos.category.partials.category_options', [
													'category' => $category,
													'level' => 0,
													'data' => $data ?? null
												])
								...
								<div class="d-flex gap-2 justify-content-end mt-4">
								  <a href="{{ url('admin/training_video_category_list') }}" class="btn btn-outline-secondary">
									Cancel
								  </a>
...
<script src="https://code.jquery.com/jquery-3.4.1.js"></script>
	...
	$(document).on('click', '.update-button', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.training_video_category_list.update',$data->id) }}",
            data: formData,
            processData: false,
            contentType: false,
            dataType: "JSON",
