            ...
            <div class="col-md-12">
                <div class="card card-table">
					<div class="card-header d-flex align-items-center justify-content-between">
						<h5 class="card-title">Training Video Category List</h5>
						<a href="{{ url('admin/training_video_category_list/create') }}" class="btn btn-primary btn-sm ms-auto">Add Training Video Category</a>
					</div>
                            ...
                            <table id="basicExample" class="table truncate m-0 align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="{{ route('admin.training_video_category_list.edit',$value->id) }}" class="btn btn-icon btn-sm btn-danger-light rounded-pill" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit Category"><i class="ri-edit-line"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
