...
@section('title', 'Add Training Video Category')
@section('content')
            ...
            <div class="col-sm-12">
                <div class="card">
					<div class="card-header d-flex align-items-center justify-content-between">
						<h5 class="card-title">Add Training Video Category</h5>
						<a href="{{ url('admin/training_video_category_list') }}" class="btn btn-primary ms-auto">Training Video Category List</a>
					</div>
                    <div class="card-body booking_card">
                        <form method="post" id="add-speciality-form" action="{{ route('admin.training_video_category_list.store') }}" enctype="multipart/form-data">
                            @csrf
...
<script src="https://code.jquery.com/jquery-3.4.1.js"></script>
	...
	$(document).on('click', '.add-button', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.training_video_category_list.store') }}",
            data: formData,
            processData: false,
            contentType: false,
            dataType: "JSON",
