...
<body>
    ...
    <!-- Summernote CSS and JS (bs4 version) -->
	...
	<script type="text/javascript">
		$('#summernote1, #summernote2, #summernote3').summernote({
            ...
            fontSizes: [
                ...
                '30', '32', '36', '40', '44', '48', '50', '60', '72', '96'
            ],

            // 🔥 Full list of popular browser-safe fonts
            fontNames: [
                'Arial', 'Arial Black', 'Helvetica', 'Verdana', 'Tahoma', 'Trebuchet MS',
                'Times New Roman', 'Georgia', 'Garamond', 'Courier New', 'Monospace',
                ...
                // Google-like common fonts (if included manually via CSS)
                'Roboto', 'Poppins', 'Montserrat', 'Lato', 'Oswald', 'Open Sans',
                'Nunito', 'Source Sans Pro', 'Inter', 'Rubik', 'Raleway'
            ],

            // Ignore missing font warnings
            fontNamesIgnoreCheck: [
                'Arial', 'Arial Black', 'Helvetica', 'Verdana', 'Tahoma',
                'Trebuchet MS', 'Times New Roman', 'Georgia', 'Garamond',
                'Courier New', 'Monospace', 'Comic Sans MS', 'Impact',
                'Lucida Console', 'Lucida Sans Unicode', 'Calibri',
                'Cambria', 'Candara', 'Consolas', 'Constantia', 'Corbel',
                'Roboto', 'Poppins', 'Montserrat', 'Lato', 'Oswald',
                'Open Sans', 'Nunito', 'Source Sans Pro', 'Inter',
                'Rubik', 'Raleway'
            ],
