  ...
  <div class="modal-dialog">
    <form class="modal-content" id="generate-membership-Form" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                <label class="">Enter Membership Number</label>
                <input type="number" name="membership_number" id="membership_number" class="form-control" placeholder="Enter Membership Number">
            </div>

            <div class="mb-3">
                <label class="">Select only current Date</label>
                <input type="date" value="{{ date('Y-m-d') }}" name="created_date"  required id="created_date" class="form-control">
            </div>
...
$(document).on('click', '.saveMembershipBtn', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.membership.storeOldMembership') }}",
            data: formData,
            processData: false,
            contentType: false,
            dataType: "JSON",
