                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card custom-card">
							...
							<div class="container">
								<div class="row">
									@foreach($master_membership_generate as $mg)
									<div class="col-md-3 mb-4">
										<div class="card shadow text-center p-4 border-0 rounded-4 text-white"
											...
											<h6 class="mb-2 text-white">Card Generated on</h6>

											<h2 class="fw-bold text-white">{{ date('d M Y', strtotime($mg->created_date)) }}</h2>
											<h2 class="fw-bold text-white">{{ $mg->count }}</h2>

											<a target="_blank" href="{{ url('admin/view-membership-number/'.$mg->created_date) }}"
								...
								<div class="row">
									<div class="col-md-3 mb-4">
										<div class="card shadow text-center p-4 border-0 rounded-4 text-white"
											...
											<h6 class="mb-2">Total Physical Card </h6>

											<h2 class="fw-bold">{{$total_card}}</h2>
									...
									<div class="col-md-3 mb-4">
										<div class="card shadow text-center p-4 border-0 rounded-4 text-white"
											...
											<h6 class="mb-2">Total Transferred Card</h6>

											<h2 class="fw-bold">{{ $total_issue_cards }}</h2>
									...
									<div class="col-md-3 mb-4">
										<div class="card shadow text-center p-4 border-0 rounded-4 text-white"
											...
											<h6 class="mb-2">Total Used Card</h6>

											<h2 class="fw-bold">{{ $total_used_card }}</h2>
									...
									<div class="col-md-3 mb-4">
										<div class="card shadow text-center p-4 border-0 rounded-4 text-white"
											...
											<h6 class="mb-2">Total Available Card</h6>

											<h2 class="fw-bold">{{ $total_available_card }}</h2>
									...
									<div class="row">
										<div class="col-md-3 mb-3">
											<div class="form-group">
												<label>Select Vivah Mitra <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-3">
											<div class="form-group mt-4">
												<a class="btn btn-danger btn-sm" id="exportMembershipsBtn" title="Export Memberships" href="{{ route('admin.membership.exportMemberships') }}">
													Export Memberships
                                                </a>
							...
							<div class="table-responsive">
								<div id="user-table">
									@include('admin.membership.table_ajax', ['membership_list' => $membership_list])
								</div>
