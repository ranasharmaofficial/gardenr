										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a target="_blank" href="{{ url('admin/add-student-manual-result/'.$value->id) }}" class="badge bg-success">Add Result</a>
													<a target="_blank" href="{{ url('admin/view-student-manual-result/'.$value->id) }}" class="badge bg-info">View Result</a>
												</td>
											</tr>
											@endforeach
										</tbody>
