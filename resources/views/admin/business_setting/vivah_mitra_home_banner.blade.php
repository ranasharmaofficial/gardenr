			...
			<div class="ms-sm-1 ms-0">
				<nav>
					<ol class="breadcrumb mb-0">
						...
						<li class="breadcrumb-item active fw-normal" aria-current="page">App Sliders</li>
					</ol>
				</nav>
			</div>
		</div>
            ...
            <div class="col-sm-12 w-100 mx-auto">
                <div class="card">
                    <div class="card-body booking_card">
                        <form method="post" id="update-footer-logo-form" action="{{ route('admin.storeVivahMitraAppSliders') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row formtype">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-group d-flex align-items-center">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" placeholder="Title Big font" class="form-control" name="title">
                                        </div>
                                    </div>
                                </div>
								...
								<div class="col-md-12 mb-3">
                                    <div class="form-group d-flex align-items-center">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" placeholder="Description Small font" class="form-control" name="description">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="table table-stripped table table-hover table-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-black" style="white-space: normal; word-wrap: break-word; word-break: break-word;width:30% !important;">
											{{ $value->description }}
										</td>
                                        <td class="text-black"><img height="60" src="{{ static_asset($value->image) }}"></td>
                                        <td class="text-right">
                                            <a href="{{ route('admin.editVivahMitraAppBanner', $value->id) }}"  class="btn btn-icon btn-sm btn-info-light rounded-pill"><i class="ri-edit-line"></i></a>
											<a onclick="return confirm('Are you sure, you want to delete this?')" href="{{route('admin.deleteVivahMitraAppBanner',$value->id)}}" class="btn btn-icon btn-sm btn-danger-light rounded-pill"><i class="ri-delete-bin-line"></i></a>
										</td>
                                    </tr>
                                    @endforeach
                                </tbody>
