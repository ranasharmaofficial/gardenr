...
@section('title', 'Home Meeting List')
...
@section('content')
    ...
    <div style="background:linear-gradient(45deg,#f33057,rgb(56,88,249));"
        ...
        <div>
            <h4 class="fw-medium mb-2">Home Meeting List</h4>
            <div class="ms-sm-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ url('') }}"><i class="fa fa-home"></i> Home</a></li>
                        <li class="breadcrumb-item active">Home Meeting List</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card custom-card mt-3">
                ...
                <div class="card-header">
                    <h5 class="mb-0">Home Meeting List</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered text-nowrap" style="width:100%">
                            ...
                            <tbody id="table-data">
                                @include('admin.meeting.home_meeting_table_ajax', ['meeting_list' => $meeting_list])
                            </tbody>
