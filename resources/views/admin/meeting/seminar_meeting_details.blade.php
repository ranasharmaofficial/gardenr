...
@section('title', 'Seminar Guest Meeting Details')
...
@section('content')
    ...
    <div style="background:linear-gradient(45deg,#f33057,rgb(56,88,249));"
        ...
        <div>
            <h4 class="fw-medium mb-2">Seminar Guest Meeting Details</h4>
            <div class="ms-sm-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ url('') }}"><i class="fa fa-home"></i> Home</a></li>
                        <li class="breadcrumb-item active">Seminar Guest Meeting Details</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card custom-card mt-3">
                ...
                <div class="card-header">
                    <h5 class="mb-0">Seminar Guest Meeting Details</h5>
                </div>
			 ...
			 <div class="card mt-4">
				<div class="card-body">
					...
					<form class="row" action="{{ route('admin.seminar.guest.meeting.status.update') }}" method="POST">
						@csrf
