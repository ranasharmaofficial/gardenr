...
@section('title', 'Trainer Meeting Details')
...
@section('content')
    ...
    <div style="background:linear-gradient(45deg,#f33057,rgb(56,88,249));"
        ...
        <div>
            <h4 class="fw-medium mb-2">Trainer Meeting Details</h4>
            <div class="ms-sm-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ url('') }}"><i class="fa fa-home"></i> Home</a></li>
                        <li class="breadcrumb-item active">Trainer Meeting Details</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card custom-card mt-3">
                ...
                <div class="card-header">
                    <h5 class="mb-0">Trainer Meeting Details</h5>
                </div>
			 ...
			 <div class="card mt-4">
				<div class="card-body">
					...
					<form class="row" action="{{ route('admin.trainer.meeting.status.update') }}" method="POST">
						@csrf
						...
						<div class="form-group col-sm-6">
							<label>Amount</label>
							<input type="number" required placeholder="Enter Amount" name="amount" class="form-control">
						</div>
