        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="row row-sm">
                    ...
                    <div onclick="window.location.href='{{ url('admin/contact-enquiry') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="my-auto">
					...
					<div onclick="window.location.href='{{ url('admin/home-page-enquiry') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="my-auto">
                                    ...
                                    <div class="project-content">
                                        <h6>Home Page Enquiry</h6>
                                        <ul>
                                            <li>
                                                <strong>Total</strong>
                                                <span>{{ $data['homepage_enquiry_count'] }}</span>
                                            </li>
                    ...
                    <div onclick="window.location.href='{{ url('admin/complain-list') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="my-auto">
                    ...
                    {{--<div onclick="window.location.href='{{ url('admin/students') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="my-auto">
                        ...
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="project-content">
                                        <h6>Total Fund Disbursed</h6>
                                        <ul>
                                            <li>
                                                <strong>Fund Disbursed</strong>
                                                <span>{{ $data['total_fund_disbursed'] }}</span>
                                            </li>
