...
@section('title', 'Add Vivah Mitra Category')
@section('content')
            ...
            <div class="col-sm-12">
                <div class="card">
					<div class="card-header d-flex align-items-center justify-content-between">
						<h5 class="card-title">Add Vivah Mitra Category</h5>
						<a href="{{ url('admin/vivahmitra_categories') }}" class="btn btn-primary ms-auto">Vivah Mitra Category List</a>
					</div>
                    <div class="card-body booking_card">
                        <form method="post" id="add-speciality-form" action="{{ route('admin.vivahmitra_categories.store') }}" enctype="multipart/form-data">
                            @csrf
...
<script src="https://code.jquery.com/jquery-3.4.1.js"></script>
	...
	$(document).on('click', '.add-button', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.vivahmitra_categories.store') }}",
            data: formData,
            processData: false,
            contentType: false,
            dataType: "JSON",
