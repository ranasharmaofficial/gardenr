...
@section('title', 'Update Vivah Mitra Category')
@section('content')
				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-header d-flex align-items-center justify-content-between">
							<h5 class="card-title">Update Vivah Mitra Category</h5>
							<a href="{{ url('admin/product_categories') }}" class="btn btn-primary ms-auto">Vivah Mitra Category List</a>
						</div>
...
<script src="https://code.jquery.com/jquery-3.4.1.js"></script>
	...
	$(document).on('click', '.update-button', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.vivahmitra_categories.update',$data->id) }}",
            data: formData,
            processData: false,
            contentType: false,
            dataType: "JSON",
