...
@section('content')
    ...
    <div style="background:linear-gradient(45deg,#f33057,rgb(56,88,249));"
        ...
        <div>
            <h4 class="fw-medium mb-2">Kit Package Transactions</h4>
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item">Kit Package Management</li>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <div id="card-history-table">
                        @include('admin.staffs.vivah_mitra.vivahmitra.kit_history_table', ['transactions' => $transactions])
                    </div>
                </div>
            </div>
