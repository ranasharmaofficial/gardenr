...
@section('title', 'Vivah Mitra Incentive')
...
@section('content')
    ...
    <div style="background:linear-gradient(45deg,#f33057,rgb(56,88,249));"
        ...
        <div>
            <h4 class="fw-medium mb-2">Vivah Mitra Incentive</h4>
        ...
        <div class="container-fluid">
            ...
            <div class="card custom-card mt-3">
                ...
                <div class="card-header">
                    <h5 class="mb-0">Panchayat Vivah Mitra Incentive List</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered text-nowrap" style="width:100%">
                            ...
                            <tbody id="table-data">
                                @include('admin.staffs.incentives.vivahMitra.ajax_vivah_mitra', ['users' => $users])
                            </tbody>
