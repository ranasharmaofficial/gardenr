            ...
            <div class="col-sm-12">
                <div class="card">
					<div class="card-header d-flex align-items-center justify-content-between">
						...
						<a href="{{ route('admin.staffs.vivahMitraListInApp') }}" class="btn btn-primary ms-auto">
							Vivah Mitra Team List
						</a>
					</div>
									...
									<div class="form-group">
										...
										<select class=" form-control" id="user_type_id" name="user_type_id">
											...
											@foreach($user_type_list as $val)
												<option @if(old('user_type_id')==$val->id) selected @endif  value="{{ $val->id }}">{{ $val->name }}</option>
											@endforeach
										</select>
									</div>
								</div>
