...
@section('content')
    ...
    <div style="background:linear-gradient(45deg, #f33057, rgb(56, 88, 249));"
        ...
        <div>
            <h4 class="fw-medium mb-2">Add Vendor</h4>
            <div class="ms-sm-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.vendors.index') }}">Vendor List</a></li>
                        <li class="breadcrumb-item active fw-normal" aria-current="page">Add Vendor</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card custom-card mt-3">
                ...
                <div class="card-body">
                    ...
                    <form id="addVendorForm" action="{{ route('admin.vendors.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 d-flex gap-2">
                                <button type="submit" class="btn btn-danger" id="saveVendorBtn">
                                    Save Vendor
                                </button>
