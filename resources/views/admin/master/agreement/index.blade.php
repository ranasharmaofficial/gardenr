...
<!-- Page Header -->
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
							...
							<div class="table-responsive">
								<div id="user-table">
									@include('admin.master.agreement.agreement_table_ajax', ['agreement_list' => $agreement_list])
								</div>
		...
		<div class="modal fade" id="agreementModal" tabindex="-1">
		  <div class="modal-dialog">
			<form class="modal-content" id="agreement-Form" enctype="multipart/form-data">
				<div class="modal-header">
					<h5 class="modal-title" id="agreementModalTitle">Add Agreement</h5>
				...
				<div class="modal-body">
					...
					<div class="mb-3">
						...
						<input type="text" name="title"  id="agreement_title" class="form-control" placeholder="Agreement Title">
					</div>
					
					<div class="mb-3">
						<label class="form-label">Agreement File</label>
						<input type="file" name="file" id="agreement_file" accept="application/pdf" class="form-control" placeholder="Agreement Title">
					</div>
			  ...
			  <div class="modal-footer">
				...
				<button type="button" class="btn btn-primary saveAgreementBtn" id="saveAgreementBtn">
					Save
				</button>
...
function openAddAgreementModal() {
    ...
    $("#agreementModalTitle").text("Add Agreement");
    $('#saveAgreementBtn').show();
    $('#updateDesignationBtn').hide();

    $("#agreementError").addClass("d-none").html("");
}

	$(document).on('click', '.saveAgreementBtn', function(e) {
		e.preventDefault();
        var clk_btn = $(".saveAgreementBtn");
        clk_btn.prop('disabled', true);
        var formData = new FormData(document.getElementById("agreement-Form"));
        $.ajaxSetup({
            headers: {
    ...
    $.ajax({
        ...
        error: function(xhr){
            ...
            if(xhr.status === 422){
                ...
                $("#agreementError").removeClass("d-none").html(msg);
            }
        }
    });
}
...
function editAgreement(id){
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            $("#agreementModalTitle").text("Edit Agreement");
...
function updateDesignation(){
 ...
 function fetchUsers(page = 1) {
        ...
        $.ajax({
            url: "{{ route('admin.agreement.fetch') }}?page=" + page,
            method: "GET",
            data: {
                type,
                search
