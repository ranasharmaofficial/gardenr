                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
							...
							<div class="table-responsive">
								<div id="user-table">
									@include('admin.master.employee_target.target_table_ajax', ['target_list' => $target_list])
								</div>
		  ...
		  <div class="modal-dialog">
			<form class="modal-content" id="target-Form" enctype="multipart/form-data">
				<div class="modal-header">
					<h5 class="modal-title" id="targetModalTitle">Add Employee Target</h5>
			  ...
			  <div class="modal-body">
					...
					<div class="mb-3">
						...
						<select class="form-control" id="target_type" name="target_type">
							...
							<option value="yearly_target">Yearly Target</option>
							<option value="monthly_target">Monthly Target</option>
							<option value="10_days_target">10 Days Target</option>
							<option value="per_day_target">Per Day Target</option>
						</select>
					</div>

					<div class="mb-3">
						<label class="">Target Title <span class="text-danger">*</span></label>
						<input type="text" name="target"  id="target" class="form-control" placeholder="Target Title">
					</div>

					<div class="mb-3">
						<label class="">Target Value <span class="text-danger">*</span></label>
...
function openAddTargetModal() {
    ...
    $("#targetModalTitle").text("Add Employee Target");
    $('#saveTargetBtn').show();
...
$(document).on('click', '.saveTargetBtn', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.emp_target.store') }}",
            data: formData,
            processData: false,
            contentType: false,
            dataType: "JSON",
...
/* fetching agreement data area start */
 ...
 function fetchUsers(page = 1) {
        ...
        $.ajax({
            url: "{{ route('admin.emp_target.fetch') }}?page=" + page,
            method: "GET",
            data: {
                type,
                search
