                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
							...
							<div class="table-responsive">
								<div id="user-table">
									@include('admin.master.yearly_bonus.table_ajax', ['yearly_bonus_list' => $yearly_bonus_list])
								</div>
  ...
  <div class="modal-dialog">
    <form class="modal-content" id="yearly-bonus-Form" enctype="multipart/form-data">
		<div class="modal-header">
			<h5 class="modal-title" id="yearlyBonusModalTitle">Add Yearly Bonus</h5>
...
function openAddYearlyBonusModal() {
    ...
    $("#yearlyBonusModalTitle").text("Add Yearly Bonus");
...
$(document).on('click', '.saveYearlyBonusBtn', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('admin.yearlyBonus.store') }}",
            data: formData,
            processData: false,
            contentType: false,
            dataType: "JSON",
...
function editAgreement(id){
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            $("#yearlyBonusModalTitle").text("Edit Agreement");

            $('#saveYearlyBonusBtn').hide();
            $('#updateAgreementBtn').show();

            $('#yearlyBonusModal').modal('show');
        }
    });
}
