			...
			@foreach ($offer_list as $key => $value)
				<tr>
					...
					<td class="text-right">
						...
						<a class="btn btn-icon btn-sm btn-danger-light rounded-pill" onclick="return confirm('Are you sure, you want to delete this?')" style="" href="{{route('admin.offer.delete',$value->id)}}"><i class="ri-delete-bin-3-fill"></i></a>
					</td>
				</tr>
			@endforeach
		</tbody>
