                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
							...
							<div class="table-responsive">
								<div id="user-table">
									@include('admin.master.offers.offer_table_ajax', ['offer_list' => $offer_list])
								</div>
		  ...
		  <div class="modal-dialog">
			<form class="modal-content" id="offer-Form" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="mb-3">
						<label class="">Select Offer Type</label>
					...
					<div class="mb-3">
						<label class="">Select User Type</label>
					...
					<div class="mb-3">
						<label class="">Offer Title</label>
						<input type="text" name="title"  id="agreement_title" class="form-control" placeholder="Offer Title">
					</div>

					<div id="img-box" style="display:none;" class="mb-3">
						<label class="">Offer File</label>
						<input type="file" name="file" id="agreement_file" accept="image/*" class="form-control" placeholder="Offer File">
					</div>
					
					<div id="video-box" style="display:none;" class="mb-3">
						<label class="">Shorts Video Url</label>
						<input type="text" name="shorts_video_url" id="shorts_video_url" class="form-control" placeholder="Enter Shorts Video Url">
					</div>
...
function openAddOfferModal() {
    ...
    $("#offerModalTitle").text("Add Offer");
    $('#saveOfferBtn').show();
...
function updateDesignation(){
 ...
 function fetchUsers(page = 1) {
        ...
        $.ajax({
            url: "{{ route('admin.offer.fetch') }}?page=" + page,
            method: "GET",
            data: {
                type,
                search
