...
<!-- Page Header -->
            <div style="background:linear-gradient(45deg, #f33057, rgb( 56, 88, 249 ) );" class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                <div>
                    <h4 class="fw-medium mb-2">Membership</h4>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header d-flex justify-content-between align-items-center">
								...
								<a href="{{ url('admin/generate-vivah-mitra-code') }}"
								   class="btn btn-danger btn-sm float-end" >
								   Back
								</a>

                                <a href="{{ url('admin/membership/export-vivahmitra-memberships/'.$vivah_mitra_id) }}"
										...
										<div class="col-md-6 mb-3">
											<div class="form-group">
												...
												<div class="input-group">
													<input type="text" class="form-control" name="search" id="search" placeholder="Search by Name, Membership Number">
												</div>
											</div>
										</div>
							...
							<div class="table-responsive">
								<div id="user-table">
									@include('admin.membership.individual_membersship_of_vivah_mitra_ajax', ['membership_list' => $membership_list])
								</div>
    ...
    <form class="modal-content" id="generate-membership-Form" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="number"  id="number" class="form-control" placeholder="Type no of itmes you want to generate">
            </div>
...
/* fetching agreement data area start */
	...
	function fetchUsers(page = 1) {
        let vivah_mitra = {{ $vivah_mitra_id }};
        let search = $('#search').val();
		$.ajax({
            url: "{{ route('admin.membership.fetchVivahMitraMemberships') }}?page=" + page,
            method: "GET",
            data: {
                vivah_mitra,
                search
