                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
								...
								<div class="row">
									<div class="col-md-3 mb-4">
										<div class="card shadow text-center p-4 border-0 rounded-4 text-white"
											...
											<h6 class="mb-2">Total Kit Package </h6>
									...
									<div class="col-md-3 mb-4">
										<div class="card shadow text-center p-4 border-0 rounded-4 text-white"
											...
											<h6 class="mb-2">Total Transferred Kit Package</h6>
									...
									<div class="col-md-3 mb-4">
										<div class="card shadow text-center p-4 border-0 rounded-4 text-white"
											...
											<h6 class="mb-2">Total Used Kit Package</h6>
									...
									<div class="col-md-3 mb-4">
										<div class="card shadow text-center p-4 border-0 rounded-4 text-white"
											...
											<h6 class="mb-2">Total Available Kit Package</h6>
							...
							<div class="table-responsive">
								<div id="user-table">
									@include('admin.kit_numbers.table_ajax', ['membership_list' => $membership_list])
								</div>
  ...
  <div class="modal-dialog">
    <form class="modal-content" id="generate-membership-Form" enctype="multipart/form-data">
		<div class="modal-header">
			<h5 class="modal-title" id="generateMembershipModalTitle">Generate Kit Numbers</h5>
...
function openAddgenerateMembershipModal() {
    ...
    $("#generateMembershipModalTitle").text("Generate Kit Numbers");
...
/* fetching agreement data area start */
 ...
 function fetchUsers(page = 1) {
		...
		$.ajax({
            url: "{{ route('admin.kit.fetch') }}?page=" + page,
            method: "GET",
            data: {
                vivah_mitra,
                search
