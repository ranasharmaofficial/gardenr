														...
														<div class="form-group">
															...
															<select class="pretty-input" name="leader_id">
																...
																@foreach($vivah_mitra_list as $val)
																	<option selected value="{{ $val->id }}">{{ $val->first_name }} ({{ $val->employee_code }})</option>
																@endforeach
															</select>
														</div>
													</div>
                                                    ...
                                                    <div class="col-md-4">
														<div class="form-group">
															...
															<select class="pretty-input" required name="card_price">
																...
																<option selected value="499">499/-</option>
															</select>
														</div>
													</div>
											...
											<div class="physical-card-box">
                                                ...
                                                <div class="row mb-3 justify-content-center">
													<div class="col-md-6 mb-3">
														...
														<input type="number" readonly value="499" name="received_card_amount" style="" placeholder="रिसीव्ड कार्ड चार्ज प्राइस" class="pretty-input ">
													</div>
												</div>

												<div class="btn-area">
													<button type="button" class="btn btn-secondary btn-lg" onclick="backStep4()">Back</button>
													<button type="submit" id="submit-btn" disabled class="btn btn-success btn-lg saveMembersBtn">Submit</button>
												</div>
											</div>
										</div>
...
$(document).on('click', '.saveMembersBtn', function(e) {
	...
	$('#membership-number').on('keyup change', function () {
		...
		$.ajax({
			// url: "{{ url('admin/check-membership') }}",
            url: "{{ route('membership.checkMembership') }}",
			type: "POST",
			data: {
