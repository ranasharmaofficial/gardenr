...
@section('title') कार्य विवरण @endsection
                ...
                <div class="dashboard-area m-b30">
					...
					<div class="features-box  mt-3 mb-3">
                        ...
                        <div class="row m-b20 g-3">
							...
							<div class="col-6">
								<a href="{{ url('member/digital-card-members') }}" class="text-decoration-none">
									<div class="vivah-card">
										...
										<div class="vivah-text">कुल डिजिटल कार्ड अप्लाइ
							...
							<div class="col-6">
								<a href="{{ url('member/physical-card-members') }}" class="text-decoration-none">
									<div class="vivah-card">
										<div class="vivah-number auto-fit">
											{{ $total_physical_card }}
										</div>
										<div class="vivah-text">कुल फिज़िकल कार्ड
											<div style="font-size:13px; opacity:0.85; margin-top:6px;">
												Check Now →
											</div>
										</div>
							...
							@if($vivah_mitra_details->user_designation_id==8)
								...
								<div class="col-6">
									<a href="{{ url('member/vivah-mitra-list') }}" class="text-decoration-none">
							...
							<div class="col-6">
								<a href="{{ url('member/prakhand-vivah-mitra-list') }}" class="text-decoration-none">
									<div class="vivah-card2 action-card digital-card">
										<div class="vivah-action-text">
											प्रखण्ड विवाह मित्र लिस्ट
											<div style="font-size:13px; opacity:0.85; margin-top:6px;">
												More →
											</div>
										</div>
							...
							<div class="col-6">
								<a href="{{ url('member/dashboard') }}" class="text-decoration-none">
									<div class="vivah-card2 action-card digital-card">
										<div class="vivah-action-text">
											शादी पैकेज बुकिंग  
											<div style="font-size:13px; opacity:0.85; margin-top:6px;">
