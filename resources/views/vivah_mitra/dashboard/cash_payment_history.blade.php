...
@section('title') Cash Payment History @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0">Cash Payment History </h5>
                    </div>
                    ...
                    <div class="features-box  mt-3">
						...
						<div class="row m-b20 g-3">
							<div class="container">
								 ...
								 <h4 class="mb-3">Cash Payment History</h4>
									...
									<table class="table table-bordered table-striped">
										...
										<tbody>
											@forelse($cash_entries as $index => $entry)
											<tr>
												<td>{{ $index + 1 }}</td>
