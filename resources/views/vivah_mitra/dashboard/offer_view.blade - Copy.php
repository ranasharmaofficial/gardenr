                ...
                <div class="dashboard-area m-b30">
                    ...
                    <div class="features-box  mt-3">
						<div class="row g-3">
							...
							{{--
							@foreach($video_Offer as $value)
									<h4 style="line-height:1.6;"  class="text-primary">{{ $value->title }}</h4>
									<div class="shorts-container">

										<div class="shorts-card">
										{{--@php
											// Usage
											$video_url = $value->shorts_video_url;
											$embed_url = convertOfferShortsToEmbed1($video_url);
										@endphp
											<iframe
    src="{{ $embed_url }}?controls=0"
...
--}}
    ...
    <source src="{{ $value->shorts_video_url }}" type="video/mp4">
</video>
							@endforeach--}}
