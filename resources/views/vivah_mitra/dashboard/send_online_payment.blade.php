...
@section('title') Send Online Payment @endsection
                    ...
                    <div class="features-box  mt-3">
						...
						<div class="row m-b20 g-3">
							<div class="container">
								...
								<form method="post"  autocomplete="off" id="save-form" action="{{ route('member.sendOnlinePaymentPreview') }}"  enctype="multipart/form-data">
									@csrf
									...
									<div class="row formtype">
										...
										<div class="col-md-12 mb-3">
											<div class="form-group">
												<label style="float: left;">Enter Amount <span class="text-danger">*</span> </label>
												<input required type="number" id="amount" placeholder="Enter Amount" value="{{ old('amount') }}" class="form-control" name="amount">
											</div>
										</div>
									...
									<div class="row formtype" id="screenshot-wrapper">

										<!-- First Field -->
										<div class="col-md-4 mb-3 screenshot-group">
											<div class="form-group">
												<label style="float:left;">Select Screenshot <span class="text-danger">*</span></label>
												<div class="input-group">
													<input required type="file" class="form-control" name="screenshots[]">
