...
@section('title') प्रशिक्षण विडिओ @endsection
...
/* Hover effect */
.video_box:hover .play-btn::before {
        ...
        <div class="content-inner pt-0">
			<div class="container fb">
                 @php
					...
					function convertShortsToEmbed1($url) {
									...
									@foreach($video_list as $item)
										@if($item->video_type=='yt_shorts')
											...
											<div class="shorts-container">
												...
												@php
													...
													$embed_url = convertShortsToEmbed1($video_url);
												@endphp
													<iframe 
										...
										@if($item->video_type=='long_video')
											...
											<div class="col-12 video-col">
												<div class="video_box" onclick="openVideoModal('{{ $videoId }}')">
