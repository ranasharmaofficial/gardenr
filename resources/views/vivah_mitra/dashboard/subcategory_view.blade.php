            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0">{{ $category_details->name }}</h5>
                    </div>
			...
			<div class="container fb">
                ...
                <div class="dashboard-area m-b30">
                    ...
                    <div class="features-box  mt-3">
						...
						@if($vivah_mitra_subcategories->count())
							@foreach($vivah_mitra_subcategories as $item)
								<div class="col-6 mb-3">
									<a href="{{ url('member/category/'.$item->slug) }}" class="text-decoration-none">

										<div class="category-card h-100">
											<div class="category-img">
												<img src="{{ static_asset($item->image) }}" alt="{{ $item->name }}">
											</div>
						...
						@else
							<div class="row mb-2">
								<div class="col text-center">
									 <h5 class="text-muted">कोई डेटा उपलब्ध नहीं है</h5>
								</div>
							</div>
						@endif
