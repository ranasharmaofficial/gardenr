        ...
        <div class="content-inner pt-0">
			<div class="container fb">
                ...
                <div class="dashboard-area m-b30">
					...
					@if(count($asm_ewallet_transactions)>0)
						<div class="row mb-2 mt-3">
							<div class="col text-center">
								<h2 class="fw-bold">Showing Income report of <span style="color:green;font-weight:bold;">{{ $check_district->name }} </span></h2>
							</div>
						</div>
									...
									<table class="table table-bordered">
										...
										<tbody>
											@php
												$total = 0;
											@endphp
											@foreach($asm_ewallet_transactions as $key => $val)
												<tr>
