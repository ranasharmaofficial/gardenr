...
@section('title') Online Payment Sent Report @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0">Online Payment Sent Report </h5>
                    </div>
                ...
                <div class="dashboard-area m-b30">
                    ...
                    <div class="features-box  mt-3">
						...
						<div class="row m-b20 g-3">
							<div class="container">
								<h4 class="mb-3">Online Payment Sent Report</h4>
								...
								<table class="table table-bordered table-striped">
									...
									<tbody>
										@forelse($payment_submission as $index => $payment)
										<tr>
											<td>{{ $index + 1 }}</td>
											<td>{{ $payment->name }}</td>
