...
@section('title') Monthly Routine Work List @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0">Monthly Routine Work List </h5>
                    </div>
                ...
                <div class="dashboard-area m-b30">
                    ...
                    <div class="features-box  mt-3">
						...
						<div class="row m-b20 g-3">
							<div class="container">
								<h4 class="mb-3">Monthly Routine Work List</h4>
								...
								<table class="table table-bordered table-striped">
									...
									<tbody>
										@forelse($monthly_routine_works as $index => $val)
										<tr>
											<td>{{ $index + 1 }}</td>
