...
@section('title') Fund Transfer @endsection
						...
						<div class="row m-b20 g-3">
							...
							<div class="col-md-4">
								<div class="stat-card" style="background: linear-gradient(45deg,#4e73df,#224abe);">
									<div class="stat-title">Available Fund Wallet</div>
									<div class="stat-value">₹ {{ $vivahMitraFundWallet ?? 0 }}</div>
									<i class="fa-solid fa-indian-rupee-sign stat-icon"></i>
									
									<a href="{{ route('member.fundTransferHistory') }}" class="btn btn-danger btn-sm">View Transfer History</a>
								</div>
							</div>
							<div class="col-md-4"></div>

							<div class="container">
								<form method="post"  autocomplete="off" id="save-form" action="{{ route('member.storeFundTransfer') }}" enctype="multipart/form-data">
									@csrf
									...
									<div class="row formtype">
										<div class="col-md-12 mb-3">
											<h3 class="font-weight-bold text-primary">Transfer Fund Amount</h3>
										</div>
