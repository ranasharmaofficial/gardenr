...
@section('title') ट्रांसफ़र @endsection
                ...
                <div class="dashboard-area m-b30">
					...
					<div class="features-box  mt-3 mb-3">
                        ...
                        <div class="row m-b20 g-3">
							...
							<div class="col-6">
								<a href="{{ url('member/physical-card-received') }}" class="text-decoration-none">
									<div class="vivah-card">
										<div class="vivah-number auto-fit">
											₹ {{ $vivah_mitra_fundWallet }}
										</div>
										<div class="vivah-text">फंड बैलेंस 
							...
							<div class="col-6">
								<a href="{{ url('member/fund-transfer') }}" class="text-decoration-none">
							...
							<div class="col-6">
								<a href="{{ url('member/physical-card-transfer') }}" class="text-decoration-none">
									<div class="vivah-card2 action-card digital-card">
										<div class="vivah-action-text">
											फिज़िकल कार्ड ट्रांसफर
											<div style="font-size:13px; opacity:0.85; margin-top:6px;">
												Check →
											</div>
										</div>
							...
							<div class="col-6">
								<a href="{{ url('member/kit-transfer') }}" class="text-decoration-none">
									<div class="vivah-card2 action-card digital-card">
										<div class="vivah-action-text">
											कीट ट्रांसफर
											<div style="font-size:13px; opacity:0.85; margin-top:6px;">
							...
							<div class="col-6">
								<a href="{{ url('member/physical-card-received') }}" class="text-decoration-none">
									<div class="vivah-card">
										<div class="vivah-number auto-fit">
											{{ $total_available_physical_card_received }}
										</div>
										<div class="vivah-text">उपलब्ध फिज़िकल कार्ड  
											<div style="font-size:13px; opacity:0.85; margin-top:6px;">
												Check Now →
											</div>
										</div>
