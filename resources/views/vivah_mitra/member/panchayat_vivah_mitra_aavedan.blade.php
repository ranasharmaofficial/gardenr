            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0"> पंचायत विवाह मित्र आवेदन </h5>
                    </div>
					...
					@if($vivah_mitra_details->verify_date!=null)
						<div class="alert-box">
							<div class="alert-title">
								⚠️ प्रखंड विवाह मित्र – कृपया ध्यान दें
							</div>

							<marquee class="alert-marquee" behavior="scroll" direction="left" scrollamount="4">
								30 दिन के अंदर 10 पंचायत विवाह मित्र आवेदन करना अनिवार्य है।
							</marquee>
							@if($remaining_days > 0)
					...
					@endif
								...
								@foreach($prakhand_vivah_mitra_box_first10 as $box)
									...
									@endphp
										<div class="vivah-card applied">
											...
											<h3 style="color:green">Panchayat Vivah Mitra</h3>
									...
									@else
										...
										<div class="vivah-card blinkglow">
                                            <form method="POST" action="{{ route('member.vm.box.select') }}">
                                                @csrf
						...
						<div class="alert-box">
							...
							<p class="alert-marquee">
								पास कराने के लिए कुल 10 पंचायत मित्र आवश्यक हैं।
								परंतु, भविष्य में यदि कोई पंचायत मित्र कार्य छोड़ देता है या सक्रिय रूप से कार्य नहीं करता है, तो ऐसी स्थिति में आपकी प्रमोशन प्रक्रिया बाधित न हो, इसके लिए कम से कम 6 पंचायत मित्र अतिरिक्त (बैकअप) के रूप में चयनित व सक्रिय रखें।

								अतः कुल 16 पंचायत मित्र (10 अनिवार्य + 6 बैकअप) बनाए रखना अनिवार्य है।
							</p>
						</div>
						...
						<div class="row m-b20 g-3">
							...
							<div class="vivah-grid">
								...
								@foreach($prakhand_vivah_mitra_box_next_6 as $key => $val)
									@if($box->is_filled == 1)
										{{-- APPLIED BOX --}}
