...
@section('content')
			...
			<div class="container">
				<div class="header-content">
					...
					<div class="mid-content">
						<h5 class="mb-0"> प्रखण्ड विवाह मित्र पंजीकरण </h5>
					</div>
				...
				<div class="dashboard-area m-b30">
					...
					<div class="row m-b20 g-3">
						...
						<div class="container bg-white">
							...
							<form method="post" style="display:none;" id="save-form" action="{{ route('member.savePrakhandVivahMitra') }}"
	...
	<script>
		...
		$(document).on('submit', '#save-form', function (e) {
			...
			$.ajax({
				type: "POST",
				url: "{{ route('member.savePrakhandVivahMitra') }}",
				data: formData,
				processData: false,
				contentType: false,
				dataType: "JSON",
