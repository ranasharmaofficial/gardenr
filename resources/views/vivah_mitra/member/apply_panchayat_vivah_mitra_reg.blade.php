...
@section('content')
				...
				<div class="dashboard-area m-b30">
					...
					@if($vivah_mitra_details->status==1)
						<div class="container bg-white">
							...
							<form method="post"  style="display:none;" id="save-form" action="{{ route('member.savePanchayatVivahMitra') }}"
								...
								<div class="row formtype">
									...
									<div class="col-md-4 mb-3">
										<div class="form-group">
											...
											<input type="text" id="v-name" readonly placeholder="Enter Name" value="{{ old('name') }}"
									...
									<div class="col-md-4 mb-3">
										<div class="form-group">
											...
											<input type="tel" min="10" maxlength="10" pattern="[6-9]{1}[0-9]{9}" id="v-mobile" placeholder="Enter Mobile" value="{{ old('mobile') }}"
									...
									<div class="col-md-4 mb-3">
										<div class="form-group">
											...
											<input type="text" readonly id="v-address" value="{{ old('address') }}" placeholder="Address"
									...
									<div class="col-md-6 mb-3">
										<div class="form-group">
											...
											<input type="text" placeholder="Enter Ward No." value="{{ old('ward_no') }}" class="" name="ward_no">
										</div>
									</div>
	...
	<script>
		...
		$(document).on('submit', '#save-form', function (e) {
			...
			$.ajax({
				type: "POST",
				url: "{{ route('member.savePanchayatVivahMitra') }}",
				data: formData,
				processData: false,
				contentType: false,
				dataType: "JSON",
				success: function (data) {
					...
					if (data.status === true) {
						...
						Swal.fire({
							...
							window.location.href = "{{ url('member/panchayat-vivah-mitra-aavedan') }}";
					} else {
						Swal.fire({
							icon: "error",
							title: "Oh No!",
