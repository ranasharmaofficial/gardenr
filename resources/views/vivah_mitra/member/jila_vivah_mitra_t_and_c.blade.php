            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0"> जिला विवाह मित्र नियम और निर्देश </h5>
                    </div>
					...
					<!-- Features -->
						...
						<div class="row m-b20 g-3">
							...
							<div class="container">
								...
								<div class="card">
									<div class="title">जिला विवाह मित्र आवेदन</div>
...
flex-direction:column;
									...
									<div class="rules-title">
										<a style="color:#000;" href="{{ url('member/apply-jila-vivah-mitra') }}"> PROCEED</a>
									</div>
