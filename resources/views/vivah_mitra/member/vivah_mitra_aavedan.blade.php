...
@section('title') विवाह मित्र आवेदन @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0"> विवाह मित्र आवेदन </h5>
                    </div>
					...
					<!-- Features -->
						@if($vivah_mitra_details->verify_date!=null)
							<div class="alert-box">
								<div class="alert-title">
									⚠️ पंचायत विवाह मित्र – कृपया ध्यान दें
								</div>

								<marquee class="alert-marquee" behavior="scroll" direction="left" scrollamount="4">
									30 दिन के अंदर 10 विवाह मित्र आवेदन करना अनिवार्य है।
								</marquee>
								@if($remaining_days > 0)
						...
						<div class="alert-box">
							<div class="alert-title-secondary">
								कृपया 60 दिनों के भीतर कार्य पूर्ण करें, अन्यथा आपका स्थान स्वतः निरस्त कर अन्य योग्य आवेदक को प्रदान कर दिया जाएगा।
							</div>
						</div>
								...
								@foreach($prakhand_vivah_mitra_box_first10 as $box)
									...
									@endphp
										...
										<div class="vivah-card applied">
											...
											<h3 style="color:green">विवाह मित्र</h3>
									...
									@else
										...
										<div class="vivah-card blinkglow">
                                            <form method="POST" action="{{ route('member.vivahmitra.vivahmitraSelectBox') }}">
                                                @csrf
						...
						<div class="alert-box">
							<div class="alert-title">
								⚠️ विवाह मित्र – कृपया ध्यान दें
							</div>

							<p class="alert-marquee">
								पास कराने के लिए कुल 10 विवाह मित्र आवश्यक हैं।
								परंतु, भविष्य में यदि कोई विवाह मित्र कार्य छोड़ देता है या सक्रिय रूप से कार्य नहीं करता है, तो ऐसी स्थिति में आपकी प्रमोशन प्रक्रिया बाधित न हो, इसके लिए कम से कम 6 प्रखण्ड मित्र अतिरिक्त (बैकअप) के रूप में चयनित व सक्रिय रखें।

								अतः कुल 16 विवाह मित्र (10 अनिवार्य + 6 बैकअप) बनाए रखना अनिवार्य है।
							</p>
						</div>
