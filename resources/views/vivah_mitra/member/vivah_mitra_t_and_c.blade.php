            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0"> विवाह मित्र नियम और निर्देश </h5>
                    </div>
					...
					<!-- Features -->
						...
						<div class="row m-b20 g-3">
							...
							<div class="container">
								...
								<div class="card">
									<div class="title">विवाह मित्र आवेदन</div>
									...
									<section class="rules-section">
										...
										<h2>विवाह मित्र सामाजिक योजना</h2>
										<h3>नियमावली</h3>
...
flex-direction:column;
									...
									<div class="rules-title">
										<a style="color:#000;" href="{{ url('member/apply-vivah-mitra') }}"> PROCEED</a>
									</div>
