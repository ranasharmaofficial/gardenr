...
@section('title') प्रखण्ड विवाह मित्र से कुल आय   @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0"> प्रखण्ड विवाह मित्र से कुल आय  </h5>
                    </div>
					...
					<!-- Features -->
						<div class="alert-box">
							...
							<marquee class="alert-marquee" behavior="scroll" direction="left" scrollamount="4">
								30 दिन के अंदर 10 प्रखण्ड विवाह मित्र आवेदन करना अनिवार्य है।
							</marquee>
						</div>
							...
							<div class="vivah-grid">
								@foreach($prakhand_vivah_mitra_box_first10 as $box)
									...
									@php
										...
										$employeeWallet = $member_details
											? getWallet('employee', $member_details->id)
											: null;

										$todayIncome = 0;

										if ($employeeWallet) {
											$todayIncome = \App\Models\EWalletTransaction::where('type', 'credit')
												->where('wallet_id', $employeeWallet->id)
									...
									@endphp
										...
										<div class="vivah-card applied">
											...
											<p style="color:green;">₹&nbsp;{{ $todayIncome ?? 0 }}</p>
										</div>

									@else
										{{-- AVAILABLE BOX --}}
                                        <div class="vivah-card blinkglow">
                                            <form method="POST" action="{{ route('member.jila.jilaSelectBox') }}">
                                                @csrf
