...
@section('title') Apply Digital Membership Card @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0">डिजिटल मेम्बर्शिप अप्लाइ </h5>
                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-3">
														<div class="form-group">
															...
															<select class="pretty-input" required name="card_price">
																...
																<option selected value="699">300/-</option>
															</select>
														</div>
													</div>
											...
											<div class="physical-card-box">
												...
												<div class="row mb-3">
													<div class="col-md-4 mb-3">
														...
														<input type="file" required class="form-control" accept="image/*" name="profile_pic">
													</div>
												</div>
												...
												<p class="hindi-text">
													...
													मैं, <span style="font-size:18px;font-weight:bold;" class="highlight" id="shows-name">  </span> , यह घोषणा करती हूँ कि संस्थान” द्वारा प्रदान की जाने वाली सेवाएँ हमारे तथा हमारे परिवार के लिए एक नई मार्गदर्शन‑बचत सुविधा प्रदान करेंगी। यह मेंबरशिप ₹300/= की फीस तथा 12 माह की वैधता के साथ है
													- डिजिटल मेंबरशिप कार्ड दिया जा रहा है, जिसे सक्रिय करने के लिए <strong>₹500</strong> तक की समान खरीदारी करनी होगी।
													- यदि डिडितल कार्ड देखना हो ,तो वेबसाईट wwww.v2fbaazar.com पर जा कर लॉगिन कर देखा या डॉनलोड किया जा सकता है।

													मैं अपने पति/परिवार से परामर्श कर, सभी नियम‑निर्देशों को पढ़‑समझ कर यह घोषणा करती हूँ कि मेरा सदस्यता फॉर्म स्वीकार किया जाए और मुझे सदस्यता नंबर प्रदान किया जाए।
...
<script>
	...
	$(document).on('click', '.saveMembersBtn', function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('member.storeDigitalCardMemberData') }}",
            data: formData,
            processData: false,
            contentType: false,
            dataType: "JSON",
			success: function(data) {
                ...
                if (data.status == true) {
					...
					setTimeout(function () {
						window.location.href = "{{ url('member/digital-member-applied') }}/" + member;
					}, 1500);
                } else {
                    Swal.fire({
						icon: "error",
