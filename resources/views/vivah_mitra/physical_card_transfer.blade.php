...
@section('title') Physical Card Transfer @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0">Physical Card Transfer </h5>
                    </div>
						...
						<div class="row m-b20 g-3">
							...
							<div class="col-md-4">
								<div class="stat-card" style="background: linear-gradient(45deg,#4e73df,#224abe);">
                                    ...
                                    <a href="{{ route('member.physicalCardTransferHistory') }}" class="btn btn-danger btn-sm">Card Transfer History</a>
                                    <a href="{{ route('member.physicalCardReceived') }}" class="btn btn-success btn-sm mt-3">Card Received History</a>
								</div>
							</div>
							<div class="col-md-4"></div>

							<div class="container">
								<form method="post"  autocomplete="off" id="save-form" action="{{ route('member.transferCard') }}" enctype="multipart/form-data">
								@csrf
								...
								<div class="row formtype">
									<div class="col-md-12 mb-3">
										<h3 class="font-weight-bold text-primary">Physical Card Transfer</h3>
									</div>
