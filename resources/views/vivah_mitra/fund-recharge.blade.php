            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0">Fund Recharge</h5>
                    </div>
                ...
                <div class="dashboard-area m-b30">
                    <div class="features-box mt-3">
                        <div class="row m-b20 g-3">
							...
							<img style="margin-top: -10px;" src="{{ static_asset('assets/assets_vivah_mitra/images/fund-recharge.jpeg') }}" >
