...
@section('title') Physical Card Members @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0"> विवाह मित्र कार्ड  </h5>
                    </div>
							...
							<div class="container">
								...
								<div class="col-sm-12">
									<div class="vivah-card-wrapper">
										<img src="{{ static_asset('assets/assets_vivah_mitra/images/viva-mitra-card.jpg') }}"
										...
										<div class="vivah-card-overlay">
											...
											<div class="vivah-card-code">
												ID : {{ $vivah_mitra_details->employee_code }}
											</div>
										</div>
									</div>
								</div>
