...
@section('title') Kit Received History @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0">Kit Received History </h5>
                    </div>
								...
								<div class="table-responsive">
									<table class="table table-bordered">
										...
										{{--<tr>
													...
													<div class="notify-card">
														...
														<div class="notify-body">
															<p>
																...
																<span class="highlight">{{ $kit_received_details->quantity }} किट</span> प्राप्त कर रहा/रही हूँ।
															</p>

															<div class="note-box">
																<strong>📝 नोट:</strong><br>
																यदि किसी भी कारणवश किट मेरे पास से खो जाता है या मिस हो जाता है,
											...
											<tr>
												<th style="font-size:18px;">Quantity By</th>
												<th style="font-size:18px;">{{ $kit_received_details->quantity }}</th>
											</tr>

											<tr>
												<th style="font-size:18px;">Acccept Kit</th>
												<th style="font-size:18px;">
													@if($kit_received_details->status=='pending')
														<form method="post" id="save-form" action="{{ route('member.acceptTransfer') }}">
...
$(document).on('submit', '#save-form', function (e) {
		...
		$.ajax({
			type: "POST",
			url: "{{ route('member.acceptTransfer') }}",
			data: formData,
			processData: false,
			contentType: false,
			dataType: "JSON",
