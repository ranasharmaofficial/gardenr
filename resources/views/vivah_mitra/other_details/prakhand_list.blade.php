...
@section('title') प्रखण्ड लिस्ट @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0"> प्रखण्ड लिस्ट </h5>
                    </div>
                ...
                <div class="dashboard-area m-b30">
					...
					<div class="features-box  mt-3 mb-3">
                        ...
                        <div class="row m-b20 g-3">
							...
							<div class="col-12">
								<h5>Total Prakhand: {{ count($prakhand_list) }}</h5>
								<div class="table-responsive">
									<table class="table table-bordered">
										...
										<tbody>
											...
											@foreach($prakhand_list as $key => $val)
												...
												<tr>
													...
													<td style="vertical-align:middle;">		
														@php
															$check_block_user = \App\Models\User::where('block', $val->id)->count();
