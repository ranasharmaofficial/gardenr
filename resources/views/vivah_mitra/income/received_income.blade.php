...
@section('title') बैंक खाते में कुल प्राप्त राशि @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0">बैंक खाते में कुल प्राप्त राशि </h5>
                    </div>
									...
									<table class="table table-bordered">
										...
										<tbody>
											@php
												$total = 0;
											@endphp
											@foreach($receivedIncomeList as $key => $val)
												<tr>
													...
													<td style="vertical-align:middle;">		
														@if($val->paying_area == 'bank_account')
															<span class="badge bg-success">Received in Bank</span>
														@endif
														@if($val->paying_area == 'upi_details')
															<span class="badge bg-danger">Received Via UPI</span>
														@endif
													</td>
													<td style="vertical-align:middle;">{{ $val->utr_no }}</td>
													<td style="vertical-align:middle;">
														@if($val->screenshot)
															<img src="{{ static_asset('uploads/screenshot/'.$val->screenshot) }}" width="120">
														@endif</td>
													<td style="vertical-align:middle;">₹&nbsp;{{ number_format($val->amount, 2) }}</td>
											...
											<tr>
												<td style="text-align:right !important;" colspan="6"><b>Total&nbsp;:&nbsp;₹&nbsp;</b>{{ number_format($total, 2) }}</td>
											</tr>
										</tbody>
									</table>
								</div>
