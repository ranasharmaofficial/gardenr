  ...
  <!-- Preloader -->
    ...
    <div class="sidebar">
		<div class="author-box">
			<div class="dz-media">
				<img style="margin-top: -3px;margin-bottom: 18px;margin-left: 20px;width: 50px;height: 50px;border-radius: 50%;object-fit: cover;border: 1px solid #fff;position: absolute;transform: translateX(-50%);background: #fff;" src="{{ !empty($vivah_mitra_details->profile_pic)
							? static_asset($vivah_mitra_details->profile_pic)
							: static_asset('assets/assets_vivah_mitra/images/author/pic1.png') }}" class="" alt="author-image">
			</div>
			<div class="dz-info">
				<span>{{ timeGreeting() }}</span>
				<h5 class="name">{{ $vivah_mitra_details->first_name ?? 'Guest' }}</h5>
			</div>
		</div>
		<ul class="nav navbar-nav">
			<li class="nav-label">Main Menu</li>
			{{-- <li><a class="nav-link" href="{{ url('member/dashboard') }}">
				<span class="dz-icon bg-red light">
					<svg width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.4" d="M11.776 21.8374C9.49294 20.4273 7.37064 18.7645 5.44791 16.8796C4.09052 15.5338 3.05388 13.8905 2.41718 12.0753C1.27955 8.53523 2.60383 4.48948 6.30113 3.2884C8.25264 2.67553 10.3751 3.05175 12.0071 4.29983C13.6397 3.05315 15.7614 2.67705 17.713 3.2884C21.4103 4.48948 22.7435 8.53523 21.6058 12.0753C20.9743 13.8888 19.9438 15.5319 18.5929 16.8796C16.6684 18.7625 14.5463 20.4251 12.2648 21.8374L12.016 22L11.776 21.8374Z" fill="white"></path>
			...
			--}}
			<li><a class="nav-link" href="{{ url('member/get_notice') }}">
				<span class="dz-icon bg-green light">
					<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewbox="0 0 24 24" version="1.1" class="svg-main-icon">
						<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<rect fill="#fff" opacity="0.3" x="10" y="16" width="4" height="4" rx="2"></rect>
						</g>
					</svg>
				</span>
				<span>Notice</span>
			...
			<li>
				<a class="nav-link" href="{{ url('member/my-profile') }}">
			...
			<li>
				<a class="nav-link" href="{{ url('member/company-bank-details') }}">
					<span class="dz-icon bg-yellow light">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewbox="0 0 24 24" version="1.1" class="svg-main-icon">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<polygon points="0 0 24 0 24 24 0 24"></polygon>
			...
			--}}
			<li>
				<a class="nav-link" href="{{ route('member.memberlogout') }}">
					<span class="dz-icon bg-red light">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewbox="0 0 24 24" version="1.1" class="svg-main-icon">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<rect x="0" y="0" width="24" height="24"></rect>
								...
								<rect fill="#ff4db8" opacity="0.3" transform="translate(14.000000, 12.000000) rotate(-270.000000) translate(-14.000000, -12.000000) " x="13" y="6" width="2" height="12" rx="1"></rect>
								<path d="M21.7928932,9.79289322 C22.1834175,9.40236893 22.8165825,9.40236893 23.2071068,9.79289322 C23.5976311,10.1834175 23.5976311,10.8165825 23.2071068,11.2071068 L20.2071068,14.2071068 C19.8165825,14.5976311 19.1834175,14.5976311 18.7928932,14.2071068 L15.7928932,11.2071068 C15.4023689,10.8165825 15.4023689,10.1834175 15.7928932,9.79289322 C16.1834175,9.40236893 16.8165825,9.40236893 17.2071068,9.79289322 L19.5,12.0857864 L21.7928932,9.79289322 Z" fill="#fff" fill-rule="nonzero" transform="translate(19.500000, 12.000000) rotate(-90.000000) translate(-19.500000, -12.000000) "></path>
							</g>
						</svg>
					</span>
					<span>Logout</span>
			...
			<li class="sub-menu-down">
                <a class="nav-link" href="javascript:void(0);">
					<span class="dz-icon bg-red light">
						<svg height="18" viewbox="0 0 512 512" width="18" xmlns="http://www.w3.org/2000/svg"><g id="_40_Sidemenu" data-name="40 Sidemenu"><g fill="#a9defc"><rect height="105.52" rx="24" width="231.61" x="34.56" y="80.54"></rect><rect height="105.52" rx="24" width="231.61" x="34.56" y="203.24"></rect><rect height="105.52" rx="24" width="231.61" x="34.56" y="325.94"></rect></g><path d="m309.41 501h-274.85a20.46 20.46 0 0 1 0-40.91h254.44v-408.18h-254.44a20.46 20.46 0 0 1 0-40.91h274.85a20.46 20.46 0 0 1 20.46 20.46v449.08a20.46 20.46 0 0 1 -20.46 20.46z" fill="#f5d367"></path><path d="m491.92 241.44c-1.43-1.44-74.62-73.44-74.62-73.44a20.46 20.46 0 0 0 -28.93 29l59.55 59.55-59.55 59.55a20.46 20.46 0 0 0 28.93 28.9s73.19-72 74.62-73.41a22 22 0 0 0 0-30.14z" fill="#f5d367"></path><path d="m123.85 431.47h-65.29a24 24 0 0 1 -24-24v-57.53a24 24 0 0 1 11.65-20.58 501.22 501.22 0 0 0 77.64 102.11z" fill="#a2d4ea"></path><path d="m209.31 501h-174.75a20.46 20.46 0 1 1 0-40.91h120a499.3 499.3 0 0 0 54.75 40.91z" fill="#e2c061"></path></g></svg>
					</span>
		...
		<div class="social-icons">
				...
				<a href="https://facebook.com" target="_blank" class="social wa">
				...
				<a href="#" target="_blank" class="social ig">
					<i class="fab fa-instagram"></i>
				</a>

				<a href="#" target="_blank" class="social yt">
		...
		<div class="sidebar-bottom">
			<h6 style="font-size:14px;" class="name">GHAR AANGAN FOUNDATION</h6>
			<p>App Version 1.0</p>
        </div>
    </div>
    <!-- Sidebar End -->
