...
@section('title') अप्लाइड ट्रैनर  मीटिंग @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0"> अप्लाइड ट्रैनर  मीटिंग</h5>
                    </div>
                        ...
                        <div class="row m-b20 g-3">
							...
							<div class="card">
								<div class="card-header bg-primary text-white">
									<h4 class="mb-0 text-white">अप्लाइड ट्रैनर मीटिंग लिस्ट </h4>
								</div>
								...
								<div class="card-body">
									<div class="table-responsive"> 
										<table class="table table-bordered">
											...
											@foreach($training_meeting_list as $key => $val)
												<tr>
													<td>{{ $key+1 }}</td>
