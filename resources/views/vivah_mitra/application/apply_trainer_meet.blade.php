...
@section('title') Apply Trainer Meet @endsection
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <div class="mid-content">
                        <h5 class="mb-0"> अप्लाइ ट्रैनर मीटिंग  </h5>
                    </div>
						...
						<div class="row m-b20 g-3">
							...
							<div class="card">
								<div class="card-header bg-primary text-white">
									<h4 class="mb-0 text-white">ट्रैनर मीटिंग फोटो इस प्रकार कि होने चाहिए </h4>
								</div>

								<div class="card-body">
									<img src="{{ static_asset('assets/assets_vivah_mitra/images/meeting/trainer-meeting1.jpg') }}" class="img-fluid">
									</br>
									<img style="margin-top: 15px;" src="{{ static_asset('assets/assets_vivah_mitra/images/meeting/trainer-meeting2.jpg') }}" class="img-fluid">
								</div>
							</div>
							<div class="card">
								<div class="card-header bg-primary text-white">
									<h4 class="mb-0 text-white">ट्रैनर मीटिंग नियम एवं भुगतान विवरण</h4>
								</div>
											...
											<div class="accordion-body">
												<div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; font-family: Arial, sans-serif; background: #f9f9f9;">
													...
													<p style="font-size: 16px; line-height: 1.6; color: #333;">
														यदि आप <strong>15 से 30 दीदी</strong> (विवाह मित्र / पंचायत विवाह मित्र / प्रखंड विवाह मित्र) का 
													...
													<div style="margin-top: 15px; padding: 10px; background: #fff3cd; border-left: 5px solid #ffc107;">
														...
														<ul style="margin-top: 10px; padding-left: 20px;">
															...
															<li>* फोटो में बैठी हुई दीदियों की संख्या स्पष्ट दिखाई देनी चाहिए, ताकि गिनती की जा सके।</li>
														</ul>
													</div>
										...
										<div class="accordion-item">
											...
											<div class="accordion-body">
												<div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; font-family: Arial, sans-serif; background: #f9f9f9;">
													...
													<p style="font-size: 16px; line-height: 1.6; color: #333;">
														यदि आप <strong>31 से 60 दीदी</strong> (विवाह मित्र / पंचायत विवाह मित्र / प्रखंड विवाह मित्र) का 
														<strong>ट्रेनिंग प्रोग्राम</strong> आयोजित करते हैं,
										...
										<div class="accordion-item">
											...
											<div class="accordion-body">
												<div style="max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; font-family: Arial, sans-serif; background: #f9f9f9;">
													...
													<p style="font-size: 16px; line-height: 1.6; color: #333;">
														यदि आप <strong>61 से 100 दीदी</strong> (विवाह मित्र / पंचायत विवाह मित्र / प्रखंड विवाह मित्र) का 
														<strong>ट्रेनिंग प्रोग्राम</strong> आयोजित करते हैं,
														तो फोटो पोस्ट करने पर आपको <strong style="color: green;">₹1000/-</strong> प्रदान किया जाएगा।
													</p>
											...
											<div class="accordion-body">
												<div style="max-width: 650px; margin: auto; padding: 20px; font-family: Arial, sans-serif;">
													...
													<div style="background:#f1f8ff; padding:15px; border-radius:10px; margin-bottom:15px; border-left:5px solid #007bff;">
														<p style="margin:0; font-weight:bold;">👉 (15 से 30 दीदी)</p>
							...
							<div class="card shadow-lg">
								<div class="card-header bg-primary text-white">
									<h4 class="mb-0 text-white">Training Details Form</h4>
								</div>
