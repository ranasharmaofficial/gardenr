                    ...
                    <div class="ms-sm-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active fw-normal" aria-current="page">Student Profile</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            <div class="card-header">
								...
								{{--<a style="right: 5px;position: absolute;float: right;" href="{{ url('franchise/approved-student-list') }}" class="btn btn-danger-light btn-wave btn-sm float-right">Student List</a>--}}
                            </div>
                            <div class="card-body">
