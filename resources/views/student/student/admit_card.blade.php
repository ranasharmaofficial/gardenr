                    ...
                    <div class="ms-sm-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active fw-normal" aria-current="page">Admit Card</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
								...
								<form method="post" action="{{ route('student.generateStudentAdmitCard') }}" class="row">
										@csrf
											<div class="col-sm-6">
												...
												<select class="form-control" type="text" id="session" name="session" required >
													...
													@foreach(master_session_list() as $val)
														<option value="{{ $val->id }}">{{ $val->from_session.' - '.$val->to_session }}</option>
													@endforeach
												</select>
