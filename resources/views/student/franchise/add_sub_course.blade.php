                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card custom-card">
								...
								<form class="card-body" method="post" action="{{ route('admin.uploadSubCourseDetails') }}" enctype="multipart/form-data">
									@csrf
									<div class="row formtype">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input class="form-control" type="text" name="title" required placeholder="Sub Course Title" id="title" value="{{ old('title') }}">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="fee" placeholder="Enter Sub course fee" class="form-control" required>
