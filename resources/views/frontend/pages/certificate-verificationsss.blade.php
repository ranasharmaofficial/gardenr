		...
		<div class="container">
			<div class="ed-breadcrumb-content">
				<div class="ed-breadcrumb-text text-center headline ul-li">
					<h2 class="bread_title">Certificate Verification</h2>
					<ul>
                ...
                <div class="col-md-12">
                    <div class="it-breadcrumb-content z-index-3 text-center">
                        <div class="it-breadcrumb-title-box">
                            <h3 class="it-breadcrumb-title">Certificate Verification</h3>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <form method="get" enctype="multipart/form-data" action="">
                            ...
                            <div class="it-signup-wrap">
                                <h4 class="it-signup-title">Certificate Verification</h4>
