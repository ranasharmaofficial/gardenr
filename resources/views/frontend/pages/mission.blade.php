...
@section('title') Mission & Vision @endsection
@section('content')
<main>
                ...
                <div class="col-xl-6 col-lg-6  wow itfadeRight" data-wow-duration=".9s" data-wow-delay=".7s">
                    <div class="it-about-right-box">
                        <div class="it-about-title-box mb-20">
                            <h4 class="ed-section-title">Our vision</h4>
                        </div>
                        <div class="it-about-text pb-10">
                            <p>Our vision is to become a trusted platform for digital education, nurturing a generation of skilled and innovative minds. We aspire to make technology learning simple, engaging, and impactful—helping every learner unlock their potential and contribute meaningfully to the rapidly evolving tech landscape.</p>
                        </div>
    ...
    <div class="it-about-area ed-about-style-2 p-relative pt-50 pb-55">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6  wow itfadeRight" data-wow-duration=".9s" data-wow-delay=".7s">
                    <div class="it-about-right-box">
                        <div class="it-about-title-box mb-20">
                            <h4 class="ed-section-title">Our Mission</h4>
                        </div>
                        <div class="it-about-text pb-10">
                            <p>Our mission is to empower students, professionals, and technology enthusiasts with practical, industry-relevant computer skills. We aim to bridge the gap between traditional learning and real-world application by providing high-quality, affordable, and accessible courses that prepare learners for success in today’s digital world.</p>
                        </div>
    ...
    <!-- career-area-start -->
    <div class="it-career-area it-career-bg p-relative pt-50">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="it-career-title-box text-center mb-30">
