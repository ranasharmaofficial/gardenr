             ...
             <div class="col-md-12">
                <div class="it-breadcrumb-content z-index-3 text-center">
                   <div class="it-breadcrumb-title-box">
                      <h3 class="it-breadcrumb-title">Admit Card</h3>
                   </div>
                ...
                <div class="col-xl-6 col-lg-6">
                   <form action="#">
                      <div class="it-signup-wrap">
                         <h4 class="it-signup-title">Admit Card</h4>
                         ...
                         <div class="it-signup-btn d-sm-flex justify-content-between align-items-center mb-40">
