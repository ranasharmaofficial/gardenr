...
@section('content')
    ...
    <section style="background: #f8fdf8; padding: 60px 0;">
        <div class="container">
            <div class="text-center mb-5">
                <h2 style="font-size:3rem; font-weight:800; color:#1b5e20;">Why Partner With Us?</h2>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center" style="background:transparent; padding:0; margin-top:14px;">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}" style="color:#4ab24d;">Home</a></li>
                        <li class="breadcrumb-item active" style="color:#1aa115;">Business Plan</li>
                    </ol>
                </nav>
                <p style="font-size:1.5rem; color:#666; max-width:650px; margin:0 auto;">Join our growing network and build
                    a sustainable, profitable business in the booming plant & green products industry.</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6">
                    <div class="rm-why-card">
                        ...
                        <p>Access to 500+ varieties of premium plants, seeds, tools, and gardening essentials at competitive
                            prices.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="rm-why-card">
                        ...
                        <h4>High Earnings</h4>
                        <p>Earn attractive commissions on every sale. Our partners earn ₹15,000–₹1,50,000+ per month
                            consistently.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="rm-why-card">
                        ...
                        <h4>Team Support</h4>
                        <p>Dedicated mentor and team support to help you grow your business from day one with training &
                            guidance.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="rm-why-card">
                        ...
                        <p>No ceiling on your earnings. The more you grow your network, the more you earn with our
                            multi-level plan.</p>
                    </div>
                </div>
            </div>
    ...
    <section style="background: #fff; padding: 60px 0;">
        <div class="container">
            <div class="text-center mb-5">
                <span
                    style="background:#e8f5e9; color:#2e7d32; padding:6px 20px; border-radius:20px; font-size:1.3rem; font-weight:600;">OUR
                    PLANS</span>
    ...
    <section style="background: linear-gradient(135deg, #398d40, #acf5b0); padding: 60px 0;">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p style="color:rgba(255,255,255,0.8); font-size:1.5rem;">Earn from 6 different income sources with Rich
                    Money</p>
            </div>
            <div class="row g-4">
    ...
    <section style="background: #f8fdf8; padding: 60px 0; text-align:center;">
        <div class="container">
            <h2 style="font-size:3rem; font-weight:800; color:#1b5e20; margin-bottom:12px;">Ready to Start Your Journey?
            </h2>
            <p style="font-size:1.6rem; color:#666; margin-bottom:30px;">Join thousands of successful partners growing with
                Rich Money today.</p>
    ...
    <style>
        ...
        .rm-plan-features li i.fa-check-circle {
            color: #4caf50;
            font-size: 1.5rem;
        }

        .rm-plan-features li i.fa-times-circle {
            color: #ddd;
            font-size: 1.5rem;
        }
        ...
        .rm-plan-btn:hover {
            background: linear-gradient(135deg, #0a3d12, #2e7d32);
