    ...
    <div class="container">
        ...
        <div class="row g-4 ">
            ...
            <div class="col-lg-3 col-md-6 tg-footer-brand">
                ...
                <p class="tg-text">
                    Premium indoor &amp; outdoor plants, gardening tools, seeds and eco-friendly solutions for a greener
                    lifestyle.
                </p>
            ...
            <ul class="mobile-menu">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            ...
                            <ul>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Indoor
                                            Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Outdoor
                                            Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Flower
                                            Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Low
                                            maintenance Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1"
                                        href="{{ route('shop') }}"><span>Air-Purifier Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Cactus
                                            &amp; Succulent Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Fruit
                                            Plants</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Money
                                            Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Lucky
                                            Bamboo Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Bonsai
                                            Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1"
                                        href="{{ route('shop') }}"><span>Spiritual And Vastu Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1"
                        ...
                        <li>
                            ...
                            <ul>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Bedroom
                                            Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Kitchen
                                            Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Living
                                            Room Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Office
                                            Desk Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Plants
                                            For Shop</span></a></li>
                                <li style="list-style: none;"><a class="level1"
                        ...
                        <li>
                            ...
                            <ul>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Summer
                                            Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Winter
                                            Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>All
                                            Season Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Small
                                            Plants</span></a></li>
                                <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Medium
                                            Plants</span></a></li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li>
                    ...
                    <ul class="custom-scrollbar">
                        ...
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Plants for
                                    Anniversary</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Plants for
                                    Birthday</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Plants for
                                    Expressing Love</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Plants for
                                    Farewell</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Good Luck
                                    Plants</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Plants for
                                    Friends</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Plants for Get
                                    Well Soon</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Plants for
                                    Marriage</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Plants for
                ...
                <li>
                    ...
                    <ul>
                        <li style="list-style: none; margin-top: 20px;"><a class="level1"
                                href="{{ route('shop') }}"><span>Gardening Pebbles</span></a></li>
                        <li class="menu-item menu-item-has-children menu-parent-item" style="list-style: none;"><a
                                class="level1" href="{{ route('shop') }}"><span>Watering</span></a></li>
                        <li class="menu-item menu-item-has-children menu-parent-item" style="list-style: none;"><a
                                class="level1" href="{{ route('shop') }}"><span>Spray Pumps</span></a></li>
                        <li class="menu-item menu-item-has-children menu-parent-item" style="list-style: none;"><a
                                class="level1" href="{{ route('shop') }}"><span>Organic Fertilizers</span></a></li>
                        <li class="menu-item menu-item-has-children menu-parent-item" style="list-style: none;"><a
                                class="level1" href="{{ route('shop') }}"><span>Pruning &amp; Cutting Tools</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li style="list-style: none; margin-top: 15px;"><a class="level1"
                                href="{{ route('shop') }}"><span>Combo for Plants</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Combo for
                                    Planters</span></a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li style="list-style: none; margin-top: 15px;"><a class="level1"
                                href="{{ route('shop') }}"><span>Vagetable Seeds</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Flower
                                    Seeds</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Herb
                                    Seeds</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>Flower
                                    Bulbs</span></a></li>
                    </ul>
                ...
                <li>
                    ...
                    <ul>
                        <li style="list-style: none; margin-top: 15px;"><a class="level1"
                                href="{{ route('shop') }}"><span>UPTO 10% off</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>10% to 20%
                                    Off</span></a></li>
                        <li style="list-style: none; margin-top: 15px;"><a class="level1"
                                href="{{ route('shop') }}"><span>20% to 30% Off</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>30% to 50%
                                    Off</span></a></li>
                        <li style="list-style: none;"><a class="level1" href="{{ route('shop') }}"><span>50% and
                                    Above</span></a></li>
                    </ul>
                </li>
            </ul>
