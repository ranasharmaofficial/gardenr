    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{ static_asset('assets/assets_web/css/bootstrap.min.css') }}">

    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{ static_asset('assets/assets_web/css/demo4.min.css') }}">
    <link rel="stylesheet" href="{{ static_asset('assets/assets_web/css/style.min.css') }}">
    {{-- <link rel="stylesheet" href="assets/css/style.min.css"> --}}
    <link rel="stylesheet" type="text/css" href="{{ static_asset('assets/assets_web/vendor/fontawesome-free/css/all.min.css') }}">
