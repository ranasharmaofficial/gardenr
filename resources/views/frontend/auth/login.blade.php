...
@section('title') Franchise Login @endsection
		...
		<div class="container">
			<div class="ed-breadcrumb-content">
				<div class="ed-breadcrumb-text text-center headline ul-li">
					<h2 class="bread_title">Customer Login</h2>
					<ul>
...
@if(false)
 <main>
      <div
        class="it-breadcrumb-area it-breadcrumb-bg" data-background="{{ static_asset('assets/assets_web/images/breadcrumb.jpg') }}">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <div class="it-breadcrumb-content z-index-3 text-center">
                <div class="it-breadcrumb-title-box">
                  <h3 class="it-breadcrumb-title">Franchise Login</h3>
                </div>
              ...
              <div class="col-xl-6 col-lg-6">
                <form action="{{ route('login.post') }}" method="post">
                  ...
                  <div class="it-signup-wrap">
                    <h4 class="it-signup-title">Franchise Login</h4>
					<div class="col-md-12">
						@if ($errors->any())
							<div class="alert alert-danger">
								<ul>
