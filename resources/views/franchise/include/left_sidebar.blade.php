            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    <div class="main-sidebar-loggedin">
                        <div class="app-sidebar__user">
                            <div class="dropdown user-pro-body text-center">
                                ...
                                <div class="user-info">
                                    <h6 class=" mb-0 text-white">{{session('LoggedFranchise')->institute_name }}</h6>
                                    {{--<h6 class=" mb-0 text-white">{{session('LoggedFranchise')->first_name}}</h6>--}}
                                    <span class="fs-13 text-uppercase text-white">{{ session('LoggedFranchise')->userType }} PANEL</span>
                                </div>
                            </div>
                        </div>
                    </div>
					...
					<ul class="main-menu">
                        ...
                        <!-- Start::slide -->
                        <li class="slide">
                            <a href="{{ url('franchise/dashboard') }}" class="side-menu__item">
                        ...
                        {{-- <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">
                                <span class=" side-menu__icon">
                                 ...
                                 <span class="side-menu__label">Fund</span>
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide">
                                    <a href="{{ url('franchise/fund-received') }}" class="side-menu__item">Fund Received</a>
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide">
                                    <a href="{{ url('franchise/add-student') }}" class="side-menu__item">Add Student</a>
                                    <a href="{{ url('franchise/pending-student-list') }}" class="side-menu__item">Pending Student</a>
                                    <a href="{{ url('franchise/approved-student-list') }}" class="side-menu__item">Approved Student</a>
                                </li>
                            </ul>
                        </li>
