...
<!-- Page Header -->
        <div style="background:linear-gradient(45deg, #f33057, rgb( 56, 88, 249 ) );" class="d-sm-flex d-block align-items-center justify-content-between page-header-breadcrumb">
            <div>
                <h4 class="fw-medium mb-2">Hi, {{ session('LoggedFranchise')->first_name.' '.session('LoggedFranchise')->last_name }}!</h4>
                <div class="ms-sm-1 ms-0">
                    <nav>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Dashboard</a></li>
                            <li class="breadcrumb-item active fw-normal" aria-current="page">Hi, {{ session('LoggedFranchise')->first_name.' '.session('LoggedFranchise')->last_name }}!</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="row row-sm">
                    ...
                    <div onclick="window.location.href='{{ url('franchise/fund-received') }}'" class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="card overflow-hidden project-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="my-auto">
                                    ...
                                    <div class="project-content">
                                        ...
                                        <ul>
                                            <li>
                                                <strong>Total</strong>
                                                <span>{{$data['total_fund_received']}}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
